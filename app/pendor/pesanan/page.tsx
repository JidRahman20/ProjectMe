...
export default function PesananMasukPage() {
  ...
  const getStatusLabel = (status: string) => {
    switch (status) {
      ...
      case 'approved': return 'Disetujui - Perlu Disiapkan';
        ...
        <div className="container mx-auto px-4 py-8">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-600 dark:text-gray-400">
              Kelola pesanan yang harus disiapkan
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-6">
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-green-500">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Perlu Disiapkan</p>
              <p className="text-3xl font-bold text-green-600 dark:text-green-400">
                {orders.filter(o => o.status === 'approved').length}
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-blue-500">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Selesai</p>
              <p className="text-3xl font-bold text-blue-600 dark:text-blue-400">
                {orders.filter(o => o.status === 'completed').length}
              </p>
            </div>
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 border-l-4 border-purple-500">
              <p className="text-sm text-gray-600 dark:text-gray-400 mb-1">Total Pesanan</p>
          ...
          <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-6 mb-6">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              <div className="relative">
                ...
                <input
                  type="text"
                  placeholder="Cari berdasarkan kode atau kegiatan..."
                  value={searchTerm}
              ...
              <div className="relative">
                ...
                >
                  <option value="approved">Perlu Disiapkan</option>
                ...
                <div className="p-6">
                  ...
                  <div className="space-y-4 mb-6">
                    <div>
                      ...
                      <p className="text-gray-900 dark:text-white font-mono text-lg">{selectedOrder.code}</p>
                    </div>
