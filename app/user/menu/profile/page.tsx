  ...
  return (
    <ProtectedRoute>
      <div className="space-y-6">
        {/* Header */}
  <div className="bg-gradient-to-r from-purple-700 to-purple-600 dark:from-purple-700 dark:to-violet-600 rounded-xl p-6 text-white shadow-lg">
          <h1 className="text-3xl font-bold mb-2">Profile Saya</h1>
          <p className="text-purple-100">Kelola informasi profil Anda</p>
        </div>

        {/* Profile Card */}
        <div className="bg-white dark:bg-gray-800 rounded-xl shadow-sm border border-gray-200 dark:border-gray-700 overflow-hidden">
          {/* Cover Image */}
          <div className="h-32 bg-gradient-to-r from-purple-700 to-purple-600"></div>
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex items-end -mt-16 mb-4">
              <div className="relative">
                ...
                />
                <div className="absolute bottom-2 right-2 w-4 h-4 bg-purple-600 rounded-full border-2 border-white dark:border-gray-800"></div>
              </div>
            ...
            {/* Role Badge */}
            <div className="mb-6">
              <span className="inline-flex items-center gap-2 px-4 py-2 bg-purple-100 dark:bg-purple-900 text-purple-800 dark:text-purple-200 rounded-full text-sm font-semibold">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-purple-100 dark:bg-purple-900 flex items-center justify-center">
                      <Building className="w-5 h-5 text-purple-700 dark:text-purple-400" />
                    </div>
                    <div className="flex-1">
              ...
              <div className="space-y-4">
                ...
                <div className="space-y-3">
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900 flex items-center justify-center">
                      <Mail className="w-5 h-5 text-violet-700 dark:text-violet-400" />
                    </div>
                    <div className="flex-1">
                  ...
                  <div className="flex items-center gap-3 p-3 rounded-lg hover:bg-gray-50 dark:hover:bg-gray-700 transition-colors">
                    <div className="w-10 h-10 rounded-lg bg-violet-100 dark:bg-violet-900 flex items-center justify-center">
                      <Phone className="w-5 h-5 text-violet-700 dark:text-violet-400" />
                    </div>
                    <div className="flex-1">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-700">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                  <p className="text-xs text-purple-700 dark:text-purple-400 mb-1">Bergabung Sejak</p>
                ...
                <div className="p-4 rounded-lg bg-purple-50 dark:bg-purple-900/20 border border-purple-200 dark:border-purple-800">
                  <p className="text-xs text-purple-700 dark:text-purple-400 mb-1">Login Terakhir</p>
                  <p className="text-lg font-bold text-purple-800 dark:text-purple-300">Hari ini</p>
                </div>
                <div className="p-4 rounded-lg bg-violet-50 dark:bg-violet-900/20 border border-violet-200 dark:border-violet-800">
                  <p className="text-xs text-violet-700 dark:text-violet-400 mb-1">Status</p>
                  <p className="text-lg font-bold text-violet-800 dark:text-violet-300">Active</p>
                </div>
              </div>
            </div>
            ...
            <div className="mt-6 flex gap-3">
              <button className="flex-1 px-4 py-2 bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-800 hover:to-purple-700 text-white rounded-lg transition-colors font-medium">
                Edit Profile
              </button>
