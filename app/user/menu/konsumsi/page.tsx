...
export default function KonsumsiPage() {
  ...
  return (
    <div className="flex-1 overflow-auto bg-gradient-to-br from-purple-100/50 via-purple-50/30 to-white/90 dark:from-gray-900 dark:via-purple-950 dark:to-gray-900 min-h-screen transition-colors duration-300">
      <div className="p-3 md:p-6">
        {/* Header with gradient background */}
        <div className="relative mb-4 md:mb-6 bg-gradient-to-r from-purple-800 via-purple-700 to-purple-600 rounded-xl md:rounded-2xl p-4 md:p-6 shadow-2xl overflow-hidden">
          {/* Decorative elements */}
          <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -mr-32 -mt-32 blur-3xl"></div>
          <div className="absolute bottom-0 left-0 w-48 h-48 bg-purple-600/10 rounded-full -ml-24 -mb-24 blur-2xl"></div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-3 md:gap-4 mb-6">
          {/* Total Order Card */}
          <div className="group relative bg-gradient-to-br from-purple-800 via-purple-700 to-purple-600 rounded-xl p-3 md:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 overflow-hidden">
          ...
          {/* Dipesan Card */}
          <div className="group relative bg-gradient-to-br from-purple-700 via-purple-600 to-purple-700 rounded-xl p-3 md:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 overflow-hidden">
            <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all duration-300"></div>
            {/* Shimmer effect */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-12"></div>
          ...
          <div className="group relative bg-gradient-to-br from-purple-800 via-purple-700 to-purple-700 rounded-xl p-3 md:p-4 text-white shadow-lg hover:shadow-xl transition-all duration-300 transform hover:scale-105 hover:-translate-y-1 overflow-hidden">
            <div className="absolute inset-0 bg-white/0 group-hover:bg-white/10 transition-all duration-300"></div>
            {/* Shimmer effect */}
            <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
              <div className="absolute inset-0 -translate-x-full group-hover:translate-x-full transition-transform duration-1000 bg-gradient-to-r from-transparent via-white/30 to-transparent skew-x-12"></div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl border-2 border-purple-100 dark:border-purple-900 p-5 mb-6 transition-colors duration-300">
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            <div className="md:col-span-1">
              ...
              <div className="relative group">
                <input
                  ...
                  className="w-full pl-11 pr-4 py-3 border-2 border-purple-300 dark:border-purple-700 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none text-sm bg-purple-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-300 group-hover:border-purple-300"
                  suppressHydrationWarning
                />
                <svg className="w-5 h-5 text-purple-700 absolute left-3 top-3.5 group-focus-within:text-purple-700 transition-colors" fill="none" stroke="currentColor" viewBox="0 0 24 24">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-4 py-3 border-2 border-purple-300 dark:border-purple-700 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none text-sm bg-purple-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-300 font-medium hover:border-purple-300"
                suppressHydrationWarning
              >
            ...
            <div>
              ...
              <input
                ...
                className="w-full px-4 py-3 border-2 border-purple-300 dark:border-purple-700 rounded-xl focus:ring-2 focus:ring-purple-600 focus:border-purple-600 outline-none text-sm bg-purple-50 dark:bg-gray-700 text-gray-900 dark:text-white transition-all duration-300 hover:border-purple-300"
                suppressHydrationWarning
              />
            </div>
          ...
          {(searchQuery || filterStatus !== "Semua" || filterDateFrom || filterDateTo) && (
            <div className="mt-4 flex items-center justify-between bg-purple-50 dark:bg-purple-900/20 rounded-xl p-3 border border-purple-300 dark:border-purple-700">
              <p className="text-sm text-gray-700 dark:text-gray-300 font-medium">
                Menampilkan <span className="font-extrabold text-purple-700 dark:text-purple-400 text-lg">{getFilteredOrders().length}</span> dari <span className="font-bold text-purple-700 dark:text-purple-700">{orders.length}</span> order
              </p>
              <button
                onClick={() => {
                  setSearchQuery("");
          ...
          >
            ...
            >
              ...
              <input
                ...
                min={minDate}
                className="w-full border border-gray-300 dark:border-gray-600 rounded-lg px-4 py-2.5 focus:outline-none focus:ring-2 focus:ring-purple-600 focus:border-transparent bg-white dark:bg-gray-700 text-gray-900 dark:text-white transition-colors duration-300"
              />
              <button
                onClick={() => setShowCalendar(false)}
                className="w-full mt-4 px-4 py-2.5 bg-purple-700 text-white rounded-lg hover:bg-purple-800 transition-all duration-300 font-medium transform hover:scale-105"
              >
                Tutup
              </button>
            </div>
        ...
        {showDetailModal && selectedOrder && (
          ...
          >
            ...
            >
              {/* Header */}
              <div className="sticky top-0 bg-gradient-to-r from-purple-700 to-purple-600 text-white px-6 py-4 rounded-t-xl flex justify-between items-center">
                <div>
              ...
              <div className="p-6 space-y-6">
                ...
                {/* Informasi Kegiatan */}
                <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 rounded-lg p-5 border border-purple-300 dark:border-purple-700">
                  ...
                  <div className="space-y-2">
                    {(selectedOrder.menu || []).map((m, i) => (
                      <div className="flex items-center gap-3 bg-white dark:bg-gray-700 rounded-lg p-3 shadow-sm" key={i}>
                        <span className="flex-shrink-0 w-8 h-8 rounded-full bg-gradient-to-r from-purple-700 to-purple-600 text-white text-sm font-bold flex items-center justify-center">
                          {i + 1}
                        </span>
              ...
              <div className="sticky bottom-0 bg-gray-50 dark:bg-gray-800 px-6 py-4 rounded-b-xl border-t border-gray-200 dark:border-gray-700">
                <button
                  onClick={() => setShowDetailModal(false)}
                  className="w-full px-4 py-2.5 rounded-lg text-sm font-semibold text-white bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-800 hover:to-purple-700 transition-all shadow-md hover:shadow-lg"
                  suppressHydrationWarning
                >
                  Tutup
                </button>
            ...
            <div className="animate-in zoom-in-50 duration-200 w-full max-w-3xl">
              <form onSubmit={handleAddOrder} className="bg-white dark:bg-gray-900 rounded-xl shadow-2xl relative max-h-[90vh] flex flex-col">
                ...
                <div className="overflow-y-auto px-6 py-6 space-y-5">
                  ...
                  {/* Tanggal Section */}
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    <div className="bg-purple-50 dark:bg-purple-900/20 border-l-4 border-purple-700 dark:border-purple-500 rounded-lg p-4">
                      ...
                      <input 
                        ...
                        min={minDate}
                        className={`w-full border-0 bg-white dark:bg-gray-800 rounded-lg px-3 py-2.5 text-sm font-semibold text-purple-900 dark:text-purple-300 focus:ring-2 focus:ring-purple-600 outline-none ${
                    ...
                    <div className="bg-violet-50 dark:bg-violet-900/20 border-l-4 border-violet-600 dark:border-violet-500 rounded-lg p-4">
                      ...
                      <input 
                        ...
                        min={minDate}
                        className={`w-full border-0 bg-white dark:bg-gray-800 rounded-lg px-3 py-2.5 text-sm font-semibold text-violet-900 dark:text-violet-300 focus:ring-2 focus:ring-purple-600 outline-none ${
                  ...
                  <div className="bg-gradient-to-br from-purple-50 to-purple-100 dark:from-purple-900/20 dark:to-purple-800/20 border border-purple-300 dark:border-purple-700 rounded-lg p-5">
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      ...
                      <div>
                        ...
                        <input 
                          ...
                          min="1"
                          className={`w-full border-0 bg-white dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-600 outline-none ${
                      ...
                      <div className="md:col-span-2">
                        ...
                        <textarea 
                          ...
                          rows={2}
                          className="w-full border-0 bg-white dark:bg-gray-800 dark:text-gray-200 dark:placeholder-gray-500 rounded-lg px-3 py-2 text-sm focus:ring-2 focus:ring-purple-600 outline-none resize-none"
                          suppressHydrationWarning
                        />
                      </div>
                    </div>
                  ...
                  <div className="bg-gradient-to-br from-violet-50 to-violet-100 dark:from-violet-900/20 dark:to-violet-800/20 border border-violet-200 dark:border-violet-700 rounded-lg p-5">
                    <div className="flex justify-between items-center mb-4">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 bg-gradient-to-r from-purple-700 to-purple-600 text-white text-xs font-semibold rounded-lg hover:from-purple-800 hover:to-purple-700 transition-all shadow-sm flex items-center gap-1.5"
                      >
                    ...
                    {form.waktu && form.tamu && !form.jumlahTamu && (
                      <div className="mb-4 bg-purple-100 dark:bg-purple-900/30 border border-purple-300 dark:border-purple-700 rounded-lg p-3 flex items-start gap-2">
                        <svg className="w-5 h-5 text-purple-700 dark:text-purple-400 flex-shrink-0 mt-0.5" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                          <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M13 16h-1v-4h-1m1-4h.01M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                        </svg>
                              ...
                              <tr key={item.id}>
                                ...
                                <td className="px-2 py-2">
                                  <input
                                    ...
                                    placeholder="0"
                                    min="0"
                                    className="w-full border border-gray-300 dark:border-gray-600 bg-white dark:bg-gray-700 dark:text-gray-200 dark:placeholder-gray-500 text-sm focus:ring-2 focus:ring-purple-600 rounded px-2 py-1.5 outline-none"
                                  />
                                </td>
                  ...
                  <button
                    ...
                    className={`flex-1 px-4 py-2.5 rounded-lg text-sm font-semibold transition-all shadow-md ${
                      isFormValid() && !isSubmitting
                        ? "text-white bg-gradient-to-r from-purple-700 to-purple-600 hover:from-purple-800 hover:to-purple-700 hover:shadow-lg cursor-pointer"
            ...
            <div className="bg-white dark:bg-gray-800 rounded-xl shadow-lg p-16 border border-gray-200 dark:border-gray-700 transition-all duration-300">
              <div className="flex flex-col items-center justify-center text-center">
                <div className="bg-gradient-to-br from-purple-50 to-violet-50 dark:from-purple-900/20 dark:to-violet-900/20 rounded-full p-8 mb-6 transition-all duration-300">
                  <svg className="w-20 h-20 text-purple-700 dark:text-purple-400" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12h6m-6 4h6m2 5H7a2 2 0 01-2-2V5a2 2 0 012-2h5.586a1 1 0 01.707.293l5.414 5.414a1 1 0 01.293.707V19a2 2 0 01-2 2z" />
                  </svg>
                </div>
                <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-700 to-purple-600 dark:from-purple-400 dark:to-violet-400 bg-clip-text text-transparent mb-3">
                  {searchQuery || filterStatus !== "Semua" || filterDateFrom || filterDateTo
                ...
                {!(searchQuery || filterStatus !== "Semua" || filterDateFrom || filterDateTo) && (
                  <button
                    onClick={() => setShowForm(true)}
                    className="group relative flex items-center gap-3 bg-gradient-to-r from-purple-700 to-purple-600 text-white px-8 py-4 rounded-xl font-semibold hover:from-purple-800 hover:to-purple-700 transition-all duration-300 shadow-lg hover:shadow-xl transform hover:scale-105 overflow-hidden"
                    suppressHydrationWarning
                  >
                    {/* Shimmer effect */}
                    <div className="absolute inset-0 opacity-0 group-hover:opacity-100 transition-opacity duration-500">
            ...
            <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
              ...
              <div className="hidden md:block overflow-x-auto">
                <table className="w-full table-fixed">
                  <thead className="bg-gradient-to-r from-purple-700 to-purple-600 dark:from-purple-700 dark:to-violet-600">
                    <tr>
                      ...
                      return (
                        ...
                        >
                          ...
                          <td className="px-4 py-4">
                            ...
                            <div className="flex items-center gap-1.5 text-xs text-gray-500 dark:text-gray-400">
                              <span>oleh</span>
                              <span className="font-medium text-purple-700 dark:text-purple-400 truncate" title={order.pengaju}>
                                {order.pengaju}
                              </span>
                            </div>
                          </td>
                      ...
                      <div className="space-y-2">
                        <div>
                          ...
                          <div className="text-xs text-gray-500 dark:text-gray-400 mt-0.5">
                            oleh <span className="font-medium text-purple-700 dark:text-purple-400">{order.pengaju}</span>
                          </div>
                        </div>
