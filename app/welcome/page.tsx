...
export default function WelcomePage() {
  ...
  return (
  <div className="min-h-screen bg-gradient-to-br from-purple-50 via-violet-50 to-white dark:from-gray-900 dark:via-gray-800 dark:to-gray-900">
      {/* Navbar */}
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center h-16">
            ...
            <div className="flex items-center gap-4">
              <Link
                href="/login"
                className="px-4 py-2 text-sm font-medium text-gray-700 dark:text-gray-300 hover:text-purple-600 dark:hover:text-green-400 transition-colors"
              >
                Masuk
              </Link>
              <Link
                href="/register"
                className="px-6 py-2 text-sm font-medium text-white bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-700 hover:to-violet-600 rounded-lg transition-colors shadow-sm hover:shadow-md"
              >
                Daftar Gratis
              </Link>
            </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pt-20 pb-16">
        <div className="text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold text-white bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-700 hover:to-violet-600 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Mulai Sekarang
            ...
            <Link
              href="/login"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold text-purple-700 dark:text-purple-400 bg-white dark:bg-gray-800 border-2 border-purple-600 dark:border-purple-400 hover:bg-purple-50 dark:hover:bg-gray-700 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Login
            </Link>
          </div>
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
          {features.map((feature, index) => (
            ...
            >
              <div className="bg-gradient-to-br from-purple-600 to-violet-500 w-12 h-12 rounded-lg flex items-center justify-center mb-4">
        ...
        <div className="bg-white dark:bg-gray-800 rounded-2xl shadow-xl p-8 md:p-12 border border-gray-200 dark:border-gray-700">
          <div className="grid md:grid-cols-2 gap-8 items-center">
            <div>
              ...
              <Link
                href="/register"
                className="inline-flex items-center px-6 py-3 text-base font-semibold text-white bg-gradient-to-r from-purple-600 to-violet-500 hover:from-purple-700 hover:to-violet-600 rounded-lg transition-colors"
              >
      ...
      {/* CTA Section */}
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
  <div className="bg-gradient-to-r from-purple-600 to-violet-500 rounded-2xl shadow-xl p-8 md:p-12 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/register"
              className="inline-flex items-center px-8 py-4 text-lg font-semibold text-purple-700 bg-white hover:bg-gray-100 rounded-xl shadow-lg hover:shadow-xl transition-all transform hover:scale-105"
            >
              Daftar Sekarang
              <ArrowRight className="ml-2 w-5 h-5" />
            </Link>
