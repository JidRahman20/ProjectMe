...
export default function Home() {
  ...
  const quickAccess = [
  { name: "Absen", icon: Clock, href: "/menu/absen", color: "text-green-700 dark:text-green-400" },
    { name: "Konsumsi", icon: Activity, href: "/menu/konsumsi", color: "text-green-600 dark:text-green-400" },
  { name: "Dokumenku", icon: FileText, href: "/menu/dokumenku", color: "text-yellow-600 dark:text-yellow-400" },
  { name: "Library", icon: BookOpen, href: "/menu/library", color: "text-yellow-600 dark:text-yellow-400" },
  { name: "Employee", icon: Users, href: "/menu/employee", color: "text-green-700 dark:text-green-400" },
  { name: "Work Area", icon: Briefcase, href: "/menu/work-area", color: "text-green-700 dark:text-green-400" },
  ];
