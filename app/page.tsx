...
export default function Home() {
  ...
  const quickAccess = [
    { name: "Absen", icon: Clock, href: "/menu/absen", color: "text-green-600 dark:text-green-400" },
    { name: "Konsumsi", icon: Activity, href: "/menu/konsumsi", color: "text-yellow-600 dark:text-yellow-400" },
    { name: "Dokumenku", icon: FileText, href: "/menu/dokumenku", color: "text-green-700 dark:text-green-500" },
    { name: "Library", icon: BookOpen, href: "/menu/library", color: "text-lime-600 dark:text-lime-400" },
    { name: "Employee", icon: Users, href: "/menu/employee", color: "text-emerald-600 dark:text-emerald-400" },
    { name: "Work Area", icon: Briefcase, href: "/menu/work-area", color: "text-teal-600 dark:text-teal-400" },
  ];
